...
namespace Votr.Tests.DAL
{
    ...
    public class VotrRepositoryTest
    {
        ...
        {
            // Arrange
            Poll poll_in_db = new Poll { PollId = 1, Title = "Some Title", EndDate = DateTime.Now, StartDate = DateTime.Now };
            Poll poll_in_db_2 = new Poll { PollId = 2, Title = "Some Title 2", EndDate = DateTime.Now, StartDate = DateTime.Now };
        ...
        [TestMethod]
        public void RepoEnsureICanGetPoll()
        {
            // Arrange
            Poll poll_in_db = new Poll { PollId = 1, Title = "Some Title", EndDate = DateTime.Now, StartDate = DateTime.Now };
            Poll poll_in_db_2 = new Poll { PollId = 2, Title = "Some Title 2", EndDate = DateTime.Now, StartDate = DateTime.Now };
            ...
            ConnectMocksToDatastore();
            // datasource.Find(i => i.PollId == 1);
            // mock_polls_table.Setup(m => m.Find(It.IsAny<object[]>())).Callback((int poll_id) => datasource.Find(i => i.PollId == poll_id));
