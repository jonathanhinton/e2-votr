...
namespace Votr.DAL
{
    public class VotrRepository
    {
        ...
        public bool CastVote(int poll_id, string user_id, int option_id)
        {
            ...
            Poll found_poll = context.Polls.FirstOrDefault(i => i.PollId == poll_id);
            ApplicationUser found_user = context.Users.FirstOrDefault(i => i.Id == user_id);
            object[] things = new object[] { found_option, found_poll, found_user };
